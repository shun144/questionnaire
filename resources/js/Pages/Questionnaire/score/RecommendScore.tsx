...
const RecommendScore = () => {
  ...
  const { isGirlsLoading, answerHistories, reset, baseGirlDataList } = useQuestionnaireStore();
      ...
      <div className='flex flex-col justify-start items-center h-full w-full'>
        ...
        <div className='w-full md:w-10/12'>
          ...
          <div className='grid grid-cols-3 gap-4'>
            {
              currentItems &&
              currentItems.map(({ id, name, catchphrase, w_shukkin, diary_flg, review_flg, earn_point, today_work_flg, picture_url, mypage_url }) => (
                ...
                //   {/* <img className="object-cover w-full rounded-t-lg h-96 md:h-auto md:w-48 md:rounded-none md:rounded-s-lg" src={picture_url} alt={name} /> */}
                //   <img className="object-cover w-full rounded-t-lg h-96 md:h-auto md:w-48 md:rounded-none md:rounded-s-lg" src={""} alt={name} />
                //   <div className="flex flex-col justify-between p-4 leading-normal">
                //     <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">{name}</h5>
                //     <div>{earn_point}</div>
                //     <div>{mypage_url}</div>
...
export default memo(RecommendScore);
