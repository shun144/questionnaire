    ...
    const handleCopy = async (e: MouseEvent<HTMLButtonElement>) => {
        try {
            ...
            await navigator.clipboard.writeText(
                `${window.location.origin}/${owner}/${urlRef.current?.value}`
            );
            setShowTooltip(true);
                ...
                >
                    <div className="h-full w-2/12 flex justify-between items-center">
                        ...
                        <div className="h-10 w-16 ">
                            <button className="relative w-full h-full bg-indigo-500 px-2 text-white rounded-md shadow-xl transition-all hover:bg-indigo-600 select-none hover:shadow-xl duration-200">
                                保 存
                                {isDirty && (
                    ...
                    <div className="flex justify-start items-center pl-20 gap-x-10 w-10/12">
                        <div className=" flex flex-col items-center w-[675px]">
                            ...
                            <div className="flex w-full flex-row items-center">
                                <label
                                    htmlFor="title"
                                    className="block text-sm font-medium text-gray-800 h-10 leading-10  text-center"
                                >
                                    タイトル：
                                </label>
                                <input
                        ...
                        <div className=" flex flex-col items-center w-[580px]">
                            ...
                            <div className="flex w-full flex-row items-center">
                                ...
                                <div className="text-gray-400 border-slate-300 pr-1 text-sm">
                                ...
                                <input
                                    ...
                                    ref={urlRef}
                                    className={`grow bg-white  text-gray-900 text-sm focus:ring-transparent  block  p-2.5 h-full placeholder-slate-400 rounded ${
                                        error.url
                                            ? "border-rose-300 focus:border-rose-400 border-2"
                                            : "border-slate-400 focus:border-blue-400 border"
                                    } `}
