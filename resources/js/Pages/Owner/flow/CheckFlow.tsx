...
import QuestionCheckNode from '../QuestionCheckNode';
import RecommendNode from '../RecommendNode';
...
const CheckFlow = ({ flowId }: Props) => {
  ...
  const nodeTypes = useMemo(() => (
    {
      ...
      questionCheckNode: QuestionCheckNode,
  ...
  const handleCommit = useCallback(() => {
    if (rfInstance) {
      ...
      commitCheckFlow(flowId, flow.nodes, flow.edges, firstNodeId);
    }
  }, [rfInstance, firstNodeId]);
