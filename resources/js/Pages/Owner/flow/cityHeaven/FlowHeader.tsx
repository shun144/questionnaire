import React, { memo, useState, MouseEvent, ChangeEvent, KeyboardEvent, CompositionEvent, FormEventHandler, useEffect, useRef, useCallback } from 'react'
  ...
  return (
    <div className='h-14 w-full bg-white'>
      ...
      <div className='h-full w-full flex justify-center items-center bg-slate-100'>
        ...
        <form onSubmit={handleSubmit} className='w-full h-14 flex justify-between items-center'>
