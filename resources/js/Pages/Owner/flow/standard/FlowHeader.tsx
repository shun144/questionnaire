import React, { memo, useState, ChangeEvent, MouseEvent, KeyboardEvent, CompositionEvent, FormEventHandler, useEffect, useRef, useCallback } from 'react'
...
const StandardFlowHeader = ({ id, initialTitle, initialUrl }: Props) => {
  const { props } = usePage();
          ...
          <div className='flex justify-start items-center pl-20 gap-x-10 w-10/12'>
            ...
            <div className=' flex flex-col items-center w-96'>
              ...
              <div className='flex w-full flex-row items-center'>
                ...
                <input
                  type="text" id="url" placeholder="URLを入力してください" maxLength={15} ref={urlRef}
                ...
                <button
                  data-tooltip-id="my-tooltip" // ツールチップのIDを指定
                  data-tooltip-content="URLをコピーしました" // 表示する内容
                  onClick={handleCopy}
...
export default memo(StandardFlowHeader)
