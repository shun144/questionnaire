            ...
            <div className="h-full max-h-full w-full flex justify-center items-center overflow-hidden relative">
                ...
                <div className="w-11/12 md:w-7/12 h-full flex flex-col justify-center items-center">
                    ...
                    <div className="w-full max-h-[82%] md:max-h-[80%] min-h-[40%] bg-white/40 rounded-lg shadow-sm backdrop-blur-[4px] flex flex-col justify-center items-center px-6">
                        <div
                            className={`w-full h-2/6 max-h-2/6 min-h-2/6 overflow-y-auto mt-3 md:mt-6 flex ${
                                isResultOverHeight
                                    ? "items-start"
                                    : "items-center"
                            }`}
                        ...
                        >
                            <div
                                className="whitespace-pre-wrap w-full text-base md:text-3xl text-slate-700 font-semibold flex justify-center break-all"
                        ...
                        <div
                            className={`w-full h-4/6 max-h-4/6 min-h-4/6 overflow-y-auto mb-3 md:mb-6 flex ${
                                isMsgOverHeight ? "items-start" : "items-center"
                            }`}
                            ref={refMsg}
                        >
                            <div
                                className="whitespace-pre-wrap  w-full text-base md:text-2xl text-slate-600 font-normal flex justify-center break-all"
                                dangerouslySetInnerHTML={sanitizeText(
                                    (currentQuestionnarie as ResultType)
                                        .message!
                                )}
                            />
                        </div>
