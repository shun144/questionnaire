...
`,{models:p,connections:N}=b(k);let g=0,u=0;const S=p.length;let l=1;for(;!(l**2>=S);)l++;const B=p.map((t,r)=>{const o=g*300,a=u*300;return l%r===0?(u=0,g+=1):u+=1,{id:t.name,position:{x:o,y:a},data:t,type:"model"}}),M=N.map(t=>{const r=`${t.source}-${t.name}`;return{id:r,source:t.source,target:t.target,sourceHandle:r,targetHandle:t.target,animated:!0}}),V={model:C};function T(){const[t,r,o]=w(B),[a,d,s]=x(M);return i.jsx("div",{className:"w-screen h-screen bg-slate-950",children:i.jsxs(y,{defaultNodes:t,defaultEdges:a,nodeTypes:V,fitView:!0,fitViewOptions:{padding:.4},children:[i.jsx(A,{color:"#222",variant:E.Lines}),i.jsx(j,{})]})})}export{T as default};
